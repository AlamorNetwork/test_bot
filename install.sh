...
# --- Variables ---
REPO_URL="https://github.com/AlamorNetwork/test_bot.git"
...
install_bot() {
    ...
    apt-get update && apt-get install -y python3 python3-pip python3.10-venv git zip nginx certbot postgresql postgresql-contrib python3-certbot-nginx
